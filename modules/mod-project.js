...
let exp = {
    ...
    deploy(version, callback, options) {
        ...
        let _full_path = files.join(filesx['.local']('bak', 'pgr-assistant', _file_full_name));
    ...
    backup(callback, options) {
        ...
        let _def_bak_path = filesx['.local']('bak', 'pgr-assistant');
        ...
        let _locateProject = () => {
            ...
            throw Error('Unable to locate pgr-assistant project folder');
        };
            ...
            server: {
                ...
                '1st_step': {
                    ...
                    action: (v, d) => new Promise((resolve, reject) => {
                        ...
                        let _bak_path = filesx['.local']('bak', 'pgr-assistant');
